...
import {renderInputItem, SelectClass, OptionClass} from 'component/content/Form.jsx';
import { ApiQuery } from 'data/api';
import {clone, getDefault} from 'common/utils';
...
export const TableMixin = {
  ...
  renderFilters() {
    ...
    return filterConfig.names.map((name) => {
      return renderInputItem(items[name], name);
    });
  },
};
