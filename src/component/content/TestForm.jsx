...
import {Validation, Select, Radio} from 'antd';
...
var TestForm = React.createClass({
  ...
  render() {
    ...
    return (
      <form onSubmit={this.handleSubmit} className="ant-form-horizontal" style={{margin: '30px 0'}}>
              ...
              <div className={this.renderValidateStyle('email', this.state.isEmailOver)}>
                <Validator rules={[{required: true, type:'email', message: '请输入正确的邮箱地址'}]} trigger={this.state.emailValidateMethod}>
                  <input name="email" id="email"
                         className="ant-input" placeholder="onBlur 与 onChange 相结合"
                         value={formData.email} onBlur={this.handleEmailInputBlur} onFocus={this.handleEmailInputFocus} />
                </Validator>
              ...
              <div className={this.renderValidateStyle('passwd')}>
                <Validator rules={[{required: true, whitespace: true, message: '请填写密码'}, {validator: this.checkPass}]}>
                  <input name="passwd" id="password" className="ant-input" type="password"
                         onContextMenu={noop} onPaste={noop} onCopy={noop} onCut={noop} autocomplete="off" value={formData.passwd}/>
                </Validator>
            ...
            <div className="col-12">
              <div className={this.renderValidateStyle('rePasswd')}>
                <Validator rules={[{
                  ...
                  <input name="rePasswd" id="password2"
                         className="ant-input" type="password"
                         onContextMenu={noop} onPaste={noop} onCopy={noop} onCut={noop} autocomplete="off" value={formData.rePasswd}
